...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    music.play(music.createSong(hex`0078000408020203001c0001dc00690000045e0100040000000000000000000005640001040003060004000800012707001c00020a006400f401640000040000000000000000000000000000000003060008000c00012c`), music.PlaybackMode.UntilDone)
})
...
game.onUpdateInterval(randint(1000, 2000), function () {
    if (true) {
        rock = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Enemy)
        rock.setVelocity(randint(-50, -75), 0)
    ...
    if (true) {
        rock2 = sprites.create(img`
            ...
            . . . . . . b 6 6 c c . . . . . 
            `, SpriteKind.Enemy)
        rock2.setVelocity(randint(-50, -75), 0)
        rock2.setPosition(160, randint(0, 120))
    }
    if (true) {
